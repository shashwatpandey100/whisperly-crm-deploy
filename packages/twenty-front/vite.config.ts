  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        // manifest.json is already hand-maintained in public/ with the full
        // icon set (Windows/Android/iOS) - reuse it instead of generating one.
        manifest: false,
        workbox: {
          globPatterns: ['**/*.{js,css,html,ico,png,svg,woff2}'],
          // Twenty ships chunks up to MAIN_CHUNK_SIZE_LIMIT (6.8MB) below -
          // the default 2MB precache limit rejects several of them.
